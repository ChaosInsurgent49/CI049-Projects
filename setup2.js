...
k+= '<div class="proj" style="animation: fadeIn ease 20s;-webkit-animation: fadeIn ease 2.5s;-moz-animation: fadeIn ease 4s;-o-animation: fadeIn ease 20s;-ms-animation: fadeIn ease 20s;margin:5%;"><h3>' + projectdb[j].title + '</h3>';
