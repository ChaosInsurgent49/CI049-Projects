...
+ '{-- class="mp">03_Overworld_Day: Metroid Prime &amp; Fusion Soundtrack (Prime Side) - Planet Tallon IV<br>{== class="sm">V0.0.21: Super Metroid Soundtrack (GAME RIP) - Theme of Samus Aran Space Warrior==}--}'
+ '{-- class="mp">04_Boss_1: Metroid Prime &amp; Fusion Soundtrack (Prime Side) - VS. Hive Totem<br>{== class="mp2">V0.0.21: Metroid Prime 2: Echoes Soundtrack - VS. Guardian Ing==}--}'
...
+ '{-- class="mp">17-Golem: Metroid Prime &amp; Fusion Soundtrack (Prime Side) - VS. Giant Beetle--}'
...
+ '{-- class="mp">25-Queen_Bee: Metroid Prime &amp; Fusion Soundtrack (Prime Side) - VS. Thardus--}'
...
+ '{-->{== class="meme">46_Town_Day: <a class="meme" href="https://www.youtube.com/watch?v=M2p1Oq4uRgE">i have no clue what to call this</a>==}<br>{== class="mf">V0.0.21: Metroid Prime &amp; Fusion Soundtrack (Fusion Side) - Navigation Room {{needeq}}==}--}'
+ '{-->{== class="meme">47-Town_Night: <a class="meme" href="https://www.youtube.com/watch?v=fnwOYRpHtgk">CallMeCarsonLIVE outro song</a>==}<br>{== class="sm">V0.0.21: Super Metroid Soundtrack (GAME RIP) - Item Room {{needeq}}==}--}'
...
+ '{-->66_Terraria-Otherworld_Desert: [Default Terraria Music]--}'
...
+ '{-->69_Terraria-Otherworld_Dungeon: [Default Terraria Music]<br>{== class="msr">V0.0.21: Metroid: Samus Returns Soundtrack - Area 2 (Hydro Plant)==}--}'
...
+ '{-->72_Terraria-Otherworld_Snow: [Default Terraria Music]--}'
...
+ '{-- class="mp2">89_Terraria_Credits: Metroid Prime 2: Echoes Soundtrack - Ending Staff Roll--}'
+ '</ol>'
+ '<p>'
+ '{== style="color:#ff0000;">WARNING==}: The old title, desert, dungeon, sandstorm, old one\'s army, slime rain, new title tracks, storm, graveyard, underground jungle, and duke fishron tracks are potentially lethal, I haven\'t eq\'d them yet. Use at own risk</p>'
